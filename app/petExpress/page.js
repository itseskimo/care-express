...
<button className='bg-red px-[18px] py-[13px] text-white rounded-[27px] text-base lg:text-xl font-semibold tracking-wide flex items-center justify-evenly shrink-0'>Book a petsitter today<img src='../images/Icons/click-arrow.svg' className='pl-[18px]'/></button>
...
<button  className=' px-5 py-[13px] bg-red text-white rounded-[27px] text-sm md:text-xl font-semibold tracking-wide flex items-center justify-evenly'><img src='../images/Icons/calendar.svg' className='pr-4'/>Book a petsitter today</button>
</section>
...
<main className='mx-4 smd:mx-14'>
    ...
    <section className='flex flex-col lg:flex-row items-center justify-around'>
      ...
      <div className=''>
       ...
       <button className='bg-red mt-10 lg:mt-16 px-[20px] py-[13px] text-white rounded-[27px] text-base  lg:text-xl font-semibold tracking-wide hidden lg:flex items-center justify-evenly  '><img src='../images/Icons/calendar.svg' className='pr-[18px]'/>Book your petsitter</button>


      </div>
      <button className='bg-red mt-10 lg:mt-16 px-[20px] py-[13px] text-white rounded-[27px] text-base  lg:text-xl font-semibold tracking-wide lg:hidden flex items-center justify-evenly  '><img src='../images/Icons/calendar.svg' className='pr-[18px]'/>Book your petsitter</button>
...
<section className='pt-10  lg:pt-20 flex items-center  justify-center'>
     <section style={{ border: '0.4px solid #AA634D ' }} className='text-brown  box-border py-[6.8px] px-[18px] text-xs font-semibold tracking-[0.06em] rounded-2xl	flex justify-center items-center '><img src='../images/Icons/Handshake.svg' className='pr-2'/>Trusted Provider</section>
</section>
...
<div className="carousel" data-flickity='{ "wrapAround": true,"pageDots": false, "arrowShape": "M27.43,77.43l4.45-4.45L12.06,53.15H100v-6.3H12.06l19.82-19.82l-4.45-4.45L0,50L27.43,77.43z" }'>
  ...
  <h4 className='text-xl text-center font-normal text-ligrey'>Warsaw</h4>
...
<section className='h-full  w-full absolute top-0 ' style={{ background: 'linear-gradient(90deg, #FFFEFA 0%, rgba(0, 0, 0, 0) 24%, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0) 76%, #FFFEFA 100%)' }}></section>
</div>
