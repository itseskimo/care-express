...
<section className='pt-10  lg:pt-20 flex items-center  justify-center'>
     <section style={{ border: '0.4px solid #FF5E00 ' }} className='text-orange box-border py-[6.8px] px-[18px] text-xs font-semibold tracking-[0.06em] rounded-2xl	flex justify-center items-center '><img src='../images/Icons/Handshake.svg' className='pr-2'/>Trusted Provider</section>
</section>
...
<div className="carousel" data-flickity='{ "wrapAround": true ,"pageDots": false, "arrowShape": "M27.43,77.43l4.45-4.45L12.06,53.15H100v-6.3H12.06l19.82-19.82l-4.45-4.45L0,50L27.43,77.43z"}'>
  ...
  <h4 className='text-xl text-center font-normal text-orange'>Warsaw</h4>
...
<section className='h-full  w-full absolute top-0 ' style={{ background: 'linear-gradient(90deg, #FFF9F6 0%, rgba(0, 0, 0, 0) 24%, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0) 76%, #FFF9F6 100%)' }}></section>
</div>
