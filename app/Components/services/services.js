...
<main className=' flex items-center justify-center gap-1 lg:gap-20 xl:gap-0 xl:justify-between flex-wrap ' >
  ...
  <section className='w-[306px] h-[325px] flex items-center  justify-center relative	 mt-5 mx-3 cursor-pointer' onClick={()=>{window.location.href=`/nannyExpress`}}>
    <div className=' w-48	h-36 rounded-2xl absolute top-0 '>
      <img src='../images/business/nanny.png' style={{ border: '1px solid #FF5E00', borderTop:'none'}} className='rounded-2xl 	'/>
  ...
  <section className='w-[306px] h-[325px] flex items-center justify-center relative	  mt-5 mx-3 cursor-pointer' onClick={()=>{window.location.href='/seniorExpress'}}>
    <div className=' w-48	h-36 rounded-2xl absolute top-0 '>
      <img src='../images/business/senior.png'  style={{ borderLeft: '1px solid transparent', borderImage: `linear-gradient(to top, #FF5E00 , transparent  ) 2`, borderBottom: '1px solid #FF5E00',borderRight: '1px solid transparent', borderImage: `linear-gradient(to top, #FF5E00 , transparent 80% ) 2` }} className='  rounded-2xl	'/>
  ...
  <section className='w-[306px] h-[325px] flex items-center justify-center relative	 mt-5 mx-3 cursor-pointer' onClick={()=>{window.location.href='/petExpress'}}>
    <div className=' w-48	h-36 rounded-2xl absolute top-0 '>
      <img src='../images/business/pet.png'  style={{ border: '1px solid #FF5E00', borderTop:'none'}} className='rounded-2xl 	'/>
  ...
  <section className='w-[306px] h-[325px] flex items-center justify-center relative mt-5 mx-3 cursor-pointer' onClick={()=>{window.location.href='/specialExpress'}}>
    <div className=' w-48	h-36 rounded-2xl absolute top-0 '>
      <img src='../images/business/special.png'  style={{ border: '1px solid #FF5E00', borderTop:'none'}} className='rounded-2xl 	'/>
