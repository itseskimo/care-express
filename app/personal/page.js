...
<div className="carousel" data-flickity='{ "wrapAround": true,"pageDots": false , "arrowShape": "M27.43,77.43l4.45-4.45L12.06,53.15H100v-6.3H12.06l19.82-19.82l-4.45-4.45L0,50L27.43,77.43z"}'>
  ...
  <h4 className='text-xl text-center font-normal '>Warsaw</h4>
...
<section className='h-full  w-full absolute top-0 ' style={{ background: 'linear-gradient(90deg, #FFFDF4 0%, rgba(0, 0, 0, 0) 24%, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0) 76%, #FFFDF4 100%)' }}></section>
</div>
