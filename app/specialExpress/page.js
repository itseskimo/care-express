...
<button className='bg-blue px-[18px] py-[13px] text-white rounded-[27px] text-base lg:text-xl shrink-0 font-semibold tracking-wide flex items-center justify-evenly'>Book special care today<img src='../images/Icons/click-arrow.svg' className='pl-[18px]'/></button>
<h6  className='text-blue font-medium	underline underline-offset-[3px] decoration-1 pl-6 sm:pl-10 text-base lg:text-xl whitespace-nowrap cursor-pointer'>Learn more</h6>
</section>
...
<button  className=' px-5 py-[13px] bg-blue text-white rounded-[27px] text-sm md:text-xl font-semibold tracking-wide flex items-center justify-evenly'><img src='../images/Icons/calendar.svg' className='pr-4'/>Book special care today</button>
</section>
    ...
    <section className='flex flex-col lg:flex-row items-center justify-around'>
      ...
      <div className=''>
       ...
       <h2 className='text-sm lg:text-lg tracking-wide mb-5 mt-4 ml-5'>It’s you who decides which package of hours works best for you</h2>
        ...
        <button className='bg-blue mt-10 lg:mt-16 px-[20px] py-[13px] text-white rounded-[27px] text-base  lg:text-xl font-semibold tracking-wide hidden lg:flex items-center justify-evenly  '><img src='../images/Icons/calendar.svg' className='pr-[18px]'/>Book your special care</button>

      </div>
      <button className='bg-blue mt-10 lg:mt-16 px-[20px] py-[13px] text-white rounded-[27px] text-base  lg:text-xl font-semibold tracking-wide lg:hidden flex items-center justify-evenly  '><img src='../images/Icons/calendar.svg' className='pr-[18px]'/>Book your special care</button>
...
<section className='pt-10  lg:pt-20 flex items-center  justify-center'>
     <section style={{ border: '0.4px solid #0C68FF' }} className='text-blue  box-border py-[6.8px] px-[18px] text-xs font-semibold tracking-[0.06em] rounded-2xl	flex justify-center items-center '><img src='../images/Icons/Handshake.svg' className='pr-2'/>Trusted Provider</section>
</section>
