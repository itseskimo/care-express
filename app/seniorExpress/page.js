...
<section className='pt-10  lg:pt-20 flex items-center  justify-center'>
     <section style={{ border: '0.4px solid #FFA3A1 ' }} className='text-skin  box-border py-[6.8px] px-[18px] text-xs font-semibold tracking-[0.06em] rounded-2xl	flex justify-center items-center '>
      <img src='../images/Icons/Handshake.svg' className='pr-2'/>Trusted Provider
      </section>
</section>
...
<div className="carousel" data-flickity='{ "wrapAround": true,"pageDots": false, "arrowShape": "M27.43,77.43l4.45-4.45L12.06,53.15H100v-6.3H12.06l19.82-19.82l-4.45-4.45L0,50L27.43,77.43z" }'>
  ...
  <h4 className='text-xl text-center font-normal text-purple'>Warsaw</h4>
  <h6 className='text-center mt-5 tracking-[0.03em] font-medium italic text-librown leading-[37px] text-[14px] md:text-[20px]'>The agency offered us a great nanny! My daughter, who <br></br> doesn’t get along with strangers, connected<br></br> immediately with our nanny! The whole process of <br></br>selecting a nanny was quick and the contact was<br></br> hassle-free. I highly recommend it! :)</h6>
  </div>
  </div>
...
{/* <section className='h-full  w-full absolute top-0 ' style={{ background: 'linear-gradient(90deg, #FFF4F0 0%, rgba(0, 0, 0, 0) 24%, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0) 76%, #FFF4F0 100%)' }}></section> */}
<section className='h-full  w-full absolute top-0 ' style={{ background: ' linear-gradient(90deg, #FFF4F0 0%, rgba(255, 253, 244, 0) 25.46%, rgba(255, 253, 244, 0) 49.48%, rgba(255, 253, 244, 0) 74.54%, #FFF4F0 100%)' }}></section>
</div>
...
<button className='bg-purple mt-6 sm:mt-14 lg:mt-16 sxl:mt-24 px-[18px] py-[13px] text-white rounded-[27px] text-xs lg:text-xl font-semibold  flex items-center justify-evenly'><img className='pr-4' src='../images/Icons/call.svg'/><Link href='tel:+48 885 023 998'>Get in touch </Link></button>
</section>
